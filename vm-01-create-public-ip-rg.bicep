// Parameters
param resourceGroupName string = 'datadog-resource-01'
param tags object = {
  'tr:application-asset-insight': '200197'
  'tr:environment-type': 'DEVELOPMENT'
  'tr:project-name': 'netform-datadog'
}
...
//Resource Group
resource myResourceGroup 'Microsoft.Resources/resourceGroups@2023-04-01' = {
  name: resourceGroupName
  targetScope: 'Suscripción de Azure 1'
  location: location
  tags: tags
}
